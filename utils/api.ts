...
const API_BASE_URL = ENVIRONMENT ? process.env.API_DEV_URL : API_DEV_URL

interface ApiFetcherOptions {
  enableLog: boolean
}

export async function apiFetcher(input: string | URL | globalThis.Request, init?: RequestInit, options?: ApiFetcherOptions): Promise<Response> {
