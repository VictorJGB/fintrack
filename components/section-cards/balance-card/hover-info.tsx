...
export default function BalanceHoverInfo({
	totalExpense,
	totalIncome,
	totalBalance,
	fixedIncome,
	...
	return (
		<HoverCard>
			...
			<HoverCardContent className="flex flex-col items-start justify-center space-y-4 w-[400px] rounded-2xl">
				...
				<p>
					Utilizamos a soma de
					<strong className="text-primary"> recebimentos </strong>e da sua{" "}
					<strong> renda fixa mensal </strong> e os subtraimos do total de
				...
				<div className="flex items-center justify-center">
					{"("}
					<p className="text-sm">
						{formatToBRL(fixedIncome)} +{" "}
						<strong className="text-primary">{formatToBRL(totalIncome)}</strong>
					</p>
					{")"}
