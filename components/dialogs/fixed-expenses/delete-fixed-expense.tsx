...
// icons
import deleteFixedExpense from "@/actions/fixed-expenses/delete-fixed-expense";
// components
...
export default function DeleteFixedExpenseDialog({
	id,
	handleModalClose,
}: Props) {
	...
	const { mutate, isPending } = useMutation({
		...
		mutationKey: ["delete-fixed-expense"],
		onSuccess: ({ message }) => {
	...
	return (
		<Dialog open={isOpen} onOpenChange={setIsOpen}>
			...
			>
				<DialogHeader>
					<DialogTitle>Deletar despesa fixa</DialogTitle>
					<Separator />
				</DialogHeader>
